...
<li class="nav-item nav-language dropdown d-none d-md-block">
  <a class="nav-link dropdown-toggle" id="languageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
    ...
    <div class="nav-language-text">
      <p class="mb-1 text-black" id="selectedLanguage">English</p>
    </div>
  </a>
  <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
    <a class="dropdown-item" href="#" onclick="setLanguagePreference('en', 'English')">
    ...
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="#" onclick="setLanguagePreference('ar', 'Arabic')">
      <div class="nav-language-icon mr-2">
        <i class="flag-icon flag-icon-ae" title="ae"></i>
      </div>
      <div class="nav-language-text">
    ...
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="#" onclick="setLanguagePreference('fr', 'French')">
      <div class="nav-language-icon mr-2">
